              ...
              if RC6VAL==RC6MIN:#vision-controlled
                 ...
                 if self.object_found:
                    ...
                    if cycle_num<50:
                       ...
                       coeffy=0
                       gain=0.1  
                       print "gain=0.1,output x"
                    elif cycle_num>50 and cycle_num<100:
                       coeffx=0
                       coeffy=1
                       gain=0.1
                       print "gain=0.1,output y"
                    elif cycle_num>100 and cycle_num<150:
                       coeffx=1
                       coeffy=1
                       gain=0.1
                       print "gain=0.1,output xy"
                    elif cycle_num>150 and cycle_num<200:
                       coeffx=1
                       coeffy=0
                       gain=0.2  
                       print "gain=0.2,output x"
                    elif cycle_num>200 and cycle_num<250:
                       coeffx=0 
                       coeffy=1
                       gain=0.2
                       print "gain=0.2,output y"
                    elif cycle_num>250 and cycle_num<300:
                       coeffx=1
                       coeffy=1
                       gain=0.2
                       print "gain=0.2,output xy"
                    elif cycle_num>300 and cycle_num<350:
                       coeffx=1
                       coeffy=0
                       gain=0.3  
                       print "gain=0.3,output x"
                    elif cycle_num>350 and cycle_num<400:
                       coeffx=0 
                       coeffy=1
                       gain=0.3
                       print "gain=0.3,output y"
                    elif cycle_num>400 and cycle_num<450:
                       coeffx=1
                       coeffy=1
                       gain=0.3
                       print "gain=0.3,output xy"
                    elif cycle_num>450 and cycle_num<500:
                       coeffx=1
                       coeffy=0
                       gain=0.4  
                       print "gain=0.4,output x"
                    elif cycle_num>500 and cycle_num<550:
                       coeffx=0 
                       coeffy=1
                       gain=0.4
                       print "gain=0.4,output y"
                    elif cycle_num>550 and cycle_num<600:
                       coeffx=1
                       coeffy=1
                       gain=0.4
                       print "gain=0.4,output xy"
                    elif cycle_num>600 and cycle_num<650:
                       coeffx=1
                       coeffy=0
                       gain=0.5  
                       print "gain=0.5,output x"
                    elif cycle_num>650 and cycle_num<700:
                       coeffx=0 
                       coeffy=1
                       gain=0.5
                       print "gain=0.5,output y"
                    elif cycle_num>700 and cycle_num<750:
                       coeffx=1
                       coeffy=1
                       gain=0.5
                       print "gain=0.5,output xy"
                    ...
                    if self.vehicle.mode.name=="GUIDED":#visual-guided 
                       ...
                       gf.close()
                         ...
                         print "non-guided mode,object found"
                         if last_mode=="GUIDED":
                         ...
                         deltatime=time.time()-self.timelast
                         gf = open(log_gname, mode='a')
                         gf.write("%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\n"%(deltatime,0,0,xpos,ypos,0,0,0,0,size,-500))
                         gf.close()
                 else:#not-found
                   ...
                   if self.vehicle.mode.name=="GUIDED":
                       if self.object_found:
                          deltatime=time.time()-self.timelast
                          gf = open(log_gname, mode='a')
                          gf.write("%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\n"%(deltatime,0,0,xpos,ypos,0,0,0,0,size,RC6VAL))
                          gf.close()
                       else:
                          deltatime=time.time()-self.timelast
                          gf = open(log_gname, mode='a')
                          gf.write("%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\n"%(deltatime,0,0,-500,-500,0,0,0,0,-500,RC6VAL))
                          gf.close()
