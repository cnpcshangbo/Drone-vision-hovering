              ...
              if RC6VAL==1:
                 ...
                 if self.vehicle.mode.name=="GUIDED":#visual-guided
                    ...
                    if self.object_found: 
                       ...
                       upx_fo=up_total*math.cos(angle_yaw)*gain
                       upy_fo=up_total*math.sin(angle_yaw)*gain

                       print 'upx,upx_fo,upy,upy_fo',upx,upx_fo,upy,upy_fo

                       print 'err_total,up_total',error_total,up_total                       
